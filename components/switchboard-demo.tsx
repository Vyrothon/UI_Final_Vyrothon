        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
              ClearClaim connects you to the right AI agent for each task, just like a telephone switchboard operator.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="max-w-2xl text-center">
              <p className="text-muted-foreground mb-6">
                Just as switchboard operators once connected callers to the right recipients, ClearClaim intelligently routes
                your requests to the most appropriate AI models and tools. Whether you need summarization, content
                generation, data analysis, or translation, ClearClaim ensures you're always connected to the optimal AI agent
