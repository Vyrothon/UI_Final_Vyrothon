...
export default function FeatureCard({
  ...
  return (
    ...
    >
      <Card className="h-full overflow-hidden bg-white border transition-all duration-300 hover:shadow-lg dark:bg-white">
        <div className="p-6 h-full flex flex-col relative z-10 bg-white">
